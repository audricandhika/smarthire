...
<head>
    ...
    <meta name="description" content="{{ $description ?? 'SmartHire AI — AI-powered recruitment platform that screens CVs, scores candidates, and finds your best match automatically.' }}">

    <title>{{ isset($title) ? $title . ' — SmartHire AI' : 'SmartHire AI — Smarter Hiring with AI' }}</title>
    ...
    <nav class="sh-global-nav" id="global-nav" aria-label="Global navigation">
        <div class="sh-global-nav__inner">
            ...
            <ul class="sh-global-nav__links" role="list">
                ...
                <li><a href="#how-it-works" class="sh-global-nav__link">How It Works</a></li>
                <li><a href="#features" class="sh-global-nav__link">Features</a></li>
            </ul>
            ...
            <div class="sh-global-nav__actions">
                ...
                @else
                    ...
                    <a href="{{ route('register') }}" class="sh-btn-primary" id="nav-get-started">Get Started</a>
                @endauth
            </div>
        ...
        <div class="sh-global-nav__drawer" id="nav-drawer" aria-hidden="true">
            ...
            <a href="#how-it-works" class="sh-global-nav__drawer-link">How It Works</a>
            <a href="#features" class="sh-global-nav__drawer-link">Features</a>
        ...
        <div class="sh-footer__inner">
            <div class="sh-footer__grid">
                <div class="sh-footer__col">
                    ...
                    <a href="#how-it-works" class="sh-footer__link">How It Works</a>
                    <a href="#features" class="sh-footer__link">Features</a>
                </div>
                <div class="sh-footer__col">
